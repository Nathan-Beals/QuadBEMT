...
def main():
    ...
    dT, dP, P, Cd, Cl, ures, chord_meters, dL, inflow, inflow_ang, eff_aoa, dFx, dFz, Re = bemt.bemt_axial(prop, pitch, omega, tip_loss=True, mach_corr=False)
