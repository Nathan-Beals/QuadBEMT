...
def main():
    ...
    ######## Phuriwat opt of 8 element DA4002 w T = 6.313 c0max=0.1198 Reallow=1M ##########
    # omega = 4888.65227605
    # chord = np.array([0.1198, 0.2198, 0.3198, 0.4, 0.38592434, 0.3006365, 0.27586256, 0.22881419])
    # twist = np.array([0.80926495, 0.63473194, 0.46019899, 0.33972421, 0.31225507, 0.27686095, 0.26008209, 0.23952049])
    #############################################################################

    #######  NSGAII 8 element opt 2000pop 250 gen Reallow=1M pcross=0.85 T = 6.31 c0max = 0.1198###################
    # omega = 579.558520
    # chord = np.array([0.09317527, 0.14321806, 0.24253741, 0.33216906, 0.33196285, 0.2670619, 0.21319947, 0.1786755])
    # twist = np.array([0.68424264, 0.55711458, 0.39265066, 0.3276763, 0.28671502, 0.25966293, 0.22852223, 0.22965023])
    ########################################################################################

    ####### Phuriwat opt of above case w T = 6.313 c0max = 0.1198 reallow=1M ################
    # omega = 5383.38494699
    # chord = np.array([0.1198, 0.15247638, 0.25247638, 0.34187737, 0.31980274, 0.25865376, 0.21326272, 0.18582792])
    # twist = np.array([0.80421855, 0.62968563, 0.4551527, 0.31839442, 0.29512495, 0.26528716, 0.2426129, 0.22707927])
    ##########################################################################################
