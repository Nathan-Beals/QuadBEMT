...
def objfun_const_twist(xn, **kwargs):
    ...
    try:
        dT, P = bemt.bemt_axial(prop, pitch, omega, allowable_Re=allowable_Re, tip_loss=tip_loss, mach_corr=mach_corr)
...
def main():
    ...
    while not converged:
        ...
        fstr, xstr = optimize_twist(omega=omega, omega_lower=omega_lower, omega_upper=omega_upper, twist0=twist0,
                                    ...
                                    root_cutout=root_cutout, radius=radius, dy=dy, dr=dr, y=y, r=r, pitch=pitch,
                                    airfoils=airfoils, thrust=thrust, chord=chord, allowable_Re=allowable_Re, Cl_tables=Cl_tables, Cd_tables=Cd_tables)
        ...
        fstr, xstr = optimize_chord(omega=omega, omega_lower=omega_lower, omega_upper=omega_upper, chord0=chord0,
                                    ...
                                    allowable_Re=allowable_Re, Cl_tables=Cl_tables, Cd_tables=Cd_tables)
